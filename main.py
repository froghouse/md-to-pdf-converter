...
class MarkdownPDFConverter:
    ...
    def markdown_to_html(self, md_content: str) -> str:
        ...
        try:
            ...
            self.logger.error(f'Error converting Markdown to HTML. Content: {md_content[:30]}... Error: {e}')
            raise
    ...
    def html_to_pdf(
        ...
        try:
            ...
            self.logger.error(f'Unexpected error generating PDF while writing to {output_pdf_path}: {e}')
            raise
